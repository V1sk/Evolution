...
public final class ServerConfig {
    ...
    public static final String LOGIN_CALLBACK = "https://cjw-blog.net";
    public static final String LOGIN_RESULT_CALLBACK = "https://cjw-blog.net";

    public static final String AUTHORIZE_HOST = "https://dribbble.com";
    public static final String API_HOST = "https://api.dribbble.com/v2/";
